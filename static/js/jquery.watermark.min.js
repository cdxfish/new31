...
(function (a, h, y) {
    ...
    q = "watermarkFocus",
    l = "watermarkSubmit",
    o = "watermarkMaxLength",
    e = "watermarkPassword",
    d = "watermarkText",
    k = /\r/g,
    s = "input:data(" + g + "),textarea:data(" + g + ")",
    m = "input:text,input:password,input[type=search],input:not([type]),textarea",
    p = ["Page_ClientValidate"],
    r = i,
    x = u in document.createElement("input");
    ...
    a.fn.watermark = a.fn.watermark || function (p, o) {
        ...
        if (typeof o === "object") {
            ...
            s = c;
            o = a.extend({}, a.watermark.options, {
                    className : o
                })
        } else
            ...
            if (i.data(g)) {
                ...
                if ((i.attr(n) || b) === v) {
                    ...
                    i.focus(function () {
                        ...
                        var c = i[0],
                        a = e.originalEvent.dataTransfer.getData("Text");
